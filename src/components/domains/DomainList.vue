...
const headers= [
  ...
  { text: $gettext('Actions'), value: 'actions', sortable: false, align: 'right' }
]
...
function getDomainMenuItems (domain) {
  const result = [
    { label: $gettext('Administrators'), icon: 'mdi-account-supervisor', onClick: openAdminList },
    { label: $gettext('Edit'), icon: 'mdi-circle-edit-outline', onClick: editDomain },
    { label: $gettext('Delete'), icon: 'mdi-delete-outline', onClick: deleteDomain, color: 'red' }
  ]
